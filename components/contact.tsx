...
const socials: SocialLink[] = [
  ...
  },
  {
    ...
    href: "https://vk.com/sh1yden",
    icon: IconVk,
    color: "#5181B8",
  },
  {
    label: "GitHub",
    handle: "github.com/Sh1yden",
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-6xl">
        ...
        >
          Построим что-то <span className="text-[#76946A]">эффективное</span>{" "}
          вместе
        </h2>
      ...
      <footer className="mx-auto max-w-6xl mt-24 pt-8 border-t border-border flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <p className="font-mono text-xs text-muted-foreground">
          <span className="text-[#769]">&gt; shayden.ru </span> &mdash; Kirill
          (Shayden & Sh1yden) &copy; {new Date().getFullYear()}
        </p>
        <p className="font-mono text-xs text-muted-foreground">
